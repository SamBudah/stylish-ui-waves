        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mt-12">
          ...
          >
            ...
            <div>
              ...
              <div className="flex gap-3">
                <Motion whileHover={{ scale: 1.1 }} transition={{ duration: 0.2 }}>
                  <a href="#" className="p-3 rounded-full bg-secondary hover:bg-accent/10 transition-colors">
          ...
          >
            ...
            <form className="space-y-4">
              ...
              <Button className="w-full sm:w-auto button-primary flex items-center gap-2">
