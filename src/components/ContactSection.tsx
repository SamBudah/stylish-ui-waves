      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                and full-time opportunities in data analysis, UI/UX design, and
          ...
          >
            ...
            <form
              action="https://formspree.io/f/xvgdkrne"
              method="POST"
              className="space-y-6"
            >
              ...
              <Motion whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <Button
                  type="submit"
                  className="w-full bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold py-6 rounded-lg shadow-lg hover:shadow-glow transition-all flex items-center justify-center gap-2"
                >
